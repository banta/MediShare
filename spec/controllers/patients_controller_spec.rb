  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved patient as @patient" do
        ...
        post :create, {:patient => { "names" => "invalid value" }}, valid_session
        assigns(:patient).should be_a_new(Patient)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested patient" do
        ...
        Patient.any_instance.should_receive(:update_attributes).with({ "names" => "MyString" })
        put :update, {:id => patient.to_param, :patient => { "names" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the patient as @patient" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Patient.any_instance.stub(:save).and_return(false)
        put :update, {:id => patient.to_param, :patient => { "names" => "invalid value" }}, valid_session
        assigns(:patient).should eq(patient)
      end
